"""
Canonical System Visualization Dashboard (SIH PS 26130).
Unified entry point generating live multi-panel diagnostic figures and interactive HTML HUD.
"""
...
from src.core.types import CLASS_COLORS, CLASS_NAMES
        ...
        for c_id in [0, 1, 2, 3]:
            ...
            if np.any(c_mask):
                ax3.scatter(
                    ...
                    s=1.2, c=CLASS_COLORS[c_id], label=CLASS_NAMES[c_id], alpha=0.8,
                )
...
def main():
    ...
    sample_bin = Path("dataset/sequences/02/velodyne/000000.bin")
