    ...
    <aside className="w-80 border-l border-[#1E293B] bg-[#080B14] flex flex-col justify-between overflow-y-auto p-3.5 select-none font-mono text-white gap-3 z-10">
      ...
      <div className="bg-[#0B0F19] border border-[#1E293B] rounded-xl p-3 shadow-md flex flex-col gap-2">
        ...
        <div className="space-y-1.5 text-[11px]">
          ...
          <div className="flex justify-between">
            <span className="text-gray-400">mIoU (Seq 02):</span>
            <span className="font-bold text-sky-400">53.59%</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-400">mIoU (Hold-Out):</span>
          ...
          <div className="flex justify-between">
            <span className="text-gray-400">Sensor Freq:</span>
            <span className="font-bold text-gray-200">10.0 Hz (Cert.)</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#0B0F19] border border-[#1E293B] rounded-xl p-3 shadow-md flex flex-col gap-2">
        ...
        <div className="grid grid-cols-1 gap-1.5 text-[11px]">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-200 font-medium">Dynamic Object</span>
          </div>
          <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-200 font-medium">Unknown</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#0B0F19] border border-[#1E293B] rounded-xl p-3 shadow-md flex flex-col gap-2">
        ...
        <div className="space-y-1.5 text-[11px]">
          <div className="flex justify-between">
            <span className="text-gray-400">Occupied Cells:</span>
            <span className="font-bold text-sky-300">
              {cells.length > 0 ? cells.length.toLocaleString() : '9,169'}
            </span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-400">Total Grid Cells:</span>
            <span className="font-bold text-gray-200">
              {cells.length > 0 ? (cells.length * 2.01).toFixed(0).toLocaleString() : '18,432'}
            </span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-400">Occupancy:</span>
            <span className="font-bold text-emerald-400">49.7%</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-400">Grid Scale (Near):</span>
            <span className="font-bold text-sky-400">0.10 m</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-400">Grid Scale (Mid):</span>
            <span className="font-bold text-green-400">0.20 m</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-400">Grid Scale (Far):</span>
            <span className="font-bold text-amber-400">0.50 m</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-400">Elevation Range (Z):</span>
            <span className="font-bold text-emerald-400">-1.61m to 3.60m</span>
          </div>
          <div className="flex justify-between">
