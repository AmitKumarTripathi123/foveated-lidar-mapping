...
export type ColorMode = 'semantic' | 'elevation' | 'traversability' | 'intensity';

export type LayerVisibility = {
  rawPoints: boolean;
  semanticPoints: boolean;
  foveatedGrid: boolean;
  adaptiveGridWireframe: boolean;
  traversabilityMap: boolean;
  boundingBoxes: boolean;
  zoneRings: boolean;
  elevationMesh: boolean;
  egoVehicle: boolean;
